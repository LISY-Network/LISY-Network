...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the LISYNetworkTestFramework
    pass

class ExampleTest(LISYNetworkTestFramework):
    # Each functional test is a subclass of the LISYNetworkTestFramework class.
    ...
    def custom_method(self):
        ...
        LISYNetworkTestFramework class so other tests can use it."""
