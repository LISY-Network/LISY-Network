...
class TxnMallTest(LISYNetworkTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 LISY:
        ...
        # First: use raw transaction API to send 1240 LISY to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 LISY coin each
        ...
        # Node0's balance should be starting balance, plus 50LISY for another
        ...
        # Node0's total balance should be starting balance, plus 100LISY for 
