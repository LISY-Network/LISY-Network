...
By default, lisynetworkd will dump mempool on shutdown and
...
class MempoolPersistTest(LISYNetworkTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give lisynetworkd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent lisynetworkd from writing mempool.dat to disk. Verify that `savemempool` fails")
