...
class TestLISYNetworkCli(LISYNetworkTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from `lisynetwork-cli -getinfo` and the RPCs data is retrieved from.")
