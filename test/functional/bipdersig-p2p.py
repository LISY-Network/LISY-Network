...
class BIP66Test(LISYNetworkTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # lisynetworkd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and lisynetworkd produces more specific reject
            # reasons.
