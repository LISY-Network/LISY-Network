...
# TestNode: A peer we use to send messages to lisynetworkd, and store responses.
...
class CompactBlocksTest(LISYNetworkTestFramework):
    ...
    # This test actually causes lisynetworkd to (reasonably!) disconnect us, so do this last.
    ...
    # lisynetworkd's choice of nonce.
    ...
    # Test that lisynetworkd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for lisynetworkd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # lisynetworkd will not send blocktxn responses for blocks whose height is
