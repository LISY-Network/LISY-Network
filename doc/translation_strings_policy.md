...
This document provides guidelines for internationalization of the LISYNetwork Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `lisynetwork_en.ts` remains unchanged.
