/* src/config/lisynetwork-config.h.  Generated from lisynetwork-config.h.in by configure.  */
/* src/config/lisynetwork-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef LISYNETWORK_CONFIG_H

#define LISYNETWORK_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The LISYNetwork Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "LISYNetwork Core"
...
#define PACKAGE_BUGREPORT "https://github.com/LISYNetworkProject/LISYNetwork/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "LISYNetwork Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "LISYNetwork Core 2.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "lisynetwork"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://lisynetwork.org/"
