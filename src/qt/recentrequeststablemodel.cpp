    ...
    if(role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return LISYNetworkUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, LISYNetworkUnits::separatorNever);
            else
                return LISYNetworkUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount);
        }
    }
...
{
    return (this->walletModel->getOptionsModel() != nullptr) ? tr("Requested") + " ("+LISYNetworkUnits::name(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}
