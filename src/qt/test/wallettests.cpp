...
#include "qt/lisynetworkamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<LISYNetworkAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_lisynetwork-qt -platform xcb      # Linux
//     src/qt/test/test_lisynetwork-qt -platform windows  # Windows
//     src/qt/test/test_lisynetwork-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = LISYNetworkUnits::formatWithUnit(unit, balance, false, LISYNetworkUnits::separatorAlways);
    ...
    // Amount input
    LISYNetworkAmountField* amountInput = receiveCoinsDialog.findChild<LISYNetworkAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: lisynetwork:")) != -1);
