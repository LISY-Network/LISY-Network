...
#ifndef LISYNETWORK_QT_LISYNETWORKUNITS_H
#define LISYNETWORK_QT_LISYNETWORKUNITS_H
...
/** LISYNetwork unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class LISYNetworkUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit LISYNetworkUnits(QObject *parent);

    /** LISYNetwork units.
      @note Source: https://en.lisynetwork.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        LISY,
...
typedef LISYNetworkUnits::Unit LISYNetworkUnit;

#endif // LISYNETWORK_QT_LISYNETWORKUNITS_H
