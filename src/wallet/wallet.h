...
#ifndef LISYNETWORK_WALLET_WALLET_H
#define LISYNETWORK_WALLET_WALLET_H
...
public:
     ...
     * on this lisynetwork node, and set to 0 for transactions that were created
...
#endif // LISYNETWORK_WALLET_WALLET_H
