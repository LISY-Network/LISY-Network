...
#ifndef LISYNETWORK_TEST_SCRIPTNUM10_H
#define LISYNETWORK_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from LISYNetwork Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // LISYNETWORK_TEST_BIGNUM_H
