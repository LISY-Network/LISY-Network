...
{
    BOOST_CHECK(TestSplitHost("www.lisynetwork.org", "www.lisynetwork.org", -1));
    BOOST_CHECK(TestSplitHost("[www.lisynetwork.org]", "www.lisynetwork.org", -1));
    BOOST_CHECK(TestSplitHost("www.lisynetwork.org:80", "www.lisynetwork.org", 80));
    BOOST_CHECK(TestSplitHost("[www.lisynetwork.org]:80", "www.lisynetwork.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:7223", "127.0.0.1", 7223));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:7223", "127.0.0.1", 7223));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:7223", "::ffff:127.0.0.1", 7223));
    BOOST_CHECK(TestSplitHost("[::]:7223", "::", 7223));
    BOOST_CHECK(TestSplitHost("::7223", "::7223", -1));
    BOOST_CHECK(TestSplitHost(":7223", "", 7223));
    BOOST_CHECK(TestSplitHost("[]:7223", "", 7223));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:7223", "127.0.0.1:7223"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:7223", "[::]:7223"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
