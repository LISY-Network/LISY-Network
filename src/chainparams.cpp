...
// Copyright (c) 2009-2016 The LISYNetwork Core developers
...
{
    const char* pszTimestamp = "LISYNetwork 19/Aug/2020 Hello World";
    const CScript genesisOutputScript = CScript() << ParseHex("04fdd7d24e4c66186436c744abc04a70b7f3783c8745356cbc21656c9daaa4eb9ec663cf59548b09da5e98cb6a5ad65a06e16fd2363756812552915fd2f41fe9cb") << OP_CHECKSIG;
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 900000000;  //~ 4 yrs at 1 min block time
        ...
        genesis = CreateGenesisBlock(1597804417, 494881, 0x1e0ffff0, 1, 0 * COIN); 
        consensus.hashGenesisBlock = genesis.GetHash();        
        //std::cout << consensus.hashGenesisBlock.GetHex() << "\n";
        //std::cout << "Merkle: " << genesis.hashMerkleRoot.GetHex() << "\n";
        assert(consensus.hashGenesisBlock == uint256S("0x0000009fe1397c5a8a54bcec2e2caaa7c37342557d88a10d0a914db111e47be1"));
        assert(genesis.hashMerkleRoot == uint256S("0xff3f1ded43d087c4d4915b3cf38d7160613f09edbe2847a8b96f1e5953b5de6a"));

        vSeeds.emplace_back("123.57.79.198", false); 
        vSeeds.emplace_back("8.210.81.205", false); 
        ...
        chainTxData = ChainTxData{
            // Update as we know more about the contents of the LISYNetwork chain
            1597804417, // * UNIX timestamp of last known number of transactions
...
/*
        ...
        vSeeds.emplace_back("seed-testnet-lisynetwork.lisynetwork.org", false); 
        vSeeds.emplace_back("seed-testnet-lisynetwork.bitactivate.com", false); 
