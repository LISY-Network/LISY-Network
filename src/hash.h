...
#ifndef LISYNETWORK_HASH_H
#define LISYNETWORK_HASH_H
#include <iostream>
#include <chrono>
...
/** A hasher class for LISYNetwork's 256-bit hash (double SHA-256). */
class CHash256 {
private:
    CSHA256 sha;
public:
...
/** A hasher class for LISYNetwork's 160-bit hash (SHA-256 + RIPEMD-160). */
class CHash160 {
private:
    CSHA256 sha;
public:
